...
-- Listage de la structure de table sfecommerce. doctrine_migration_versions
...
-- Listage des données de la table sfecommerce.doctrine_migration_versions : ~0 rows (environ)
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	('DoctrineMigrations\\Version20231013095248', '2023-10-13 09:54:00', 1113);
...
-- Listage des données de la table sfecommerce.produit : ~17 rows (environ)
